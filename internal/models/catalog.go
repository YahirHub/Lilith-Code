...
var Catalog = []Spec{
	...
	{Key: "kimi-k2.7-code-highspeed", Name: "Kimi K2.7 Code Highspeed", MaxContext: 256_000},
	...
	{Key: "glm-5.2-fast", Name: "GLM 5.2 Fast", MaxContext: 200_000},
	...
	{Key: "qwen3.8-max", Name: "Qwen 3.8 Max", MaxContext: 1_000_000, MaxOutput: 131_072},
	{Key: "qwen3.7-max", Name: "Qwen 3.7 Max", MaxContext: 1_000_000, MaxOutput: 65_536},
	{Key: "qwen3.7-plus", Name: "Qwen 3.7 Plus", MaxContext: 1_000_000, MaxOutput: 65_536},
	{Key: "qwen3.7-flash", Name: "Qwen 3.7 Flash", MaxContext: 1_000_000, MaxOutput: 65_536},
	{Key: "qwen3.6-max", Name: "Qwen 3.6 Max Preview", MaxContext: 262_144, MaxOutput: 65_536},
	{Key: "qwen3.6-plus", Name: "Qwen 3.6 Plus", MaxContext: 1_000_000, MaxOutput: 65_536},
	...
	{Key: "hy3-paid", Name: "HY3 Paid", MaxContext: 256_000},
	...
	{Key: "nemotron-3-ultra-550b-a55b", Name: "Nemotron 3 Ultra 550B A55B", MaxContext: 1_000_000},
	...
	{Key: "step-3.7-flash", Name: "Step 3.7 Flash", MaxContext: 256_000},
	{Key: "step-3.5-flash", Name: "Step 3.5 Flash", MaxContext: 256_000},
	...
	{Key: "gpt-5.3-codex", Name: "GPT-5.3 Codex", MaxContext: 400_000, MaxOutput: 128_000},
	...
	// Anthropic
	{Key: "claude-fable-5", Name: "Claude Fable 5", MaxContext: 1_000_000, MaxOutput: 128_000},
	{Key: "claude-opus-5", Name: "Claude Opus 5", MaxContext: 1_000_000, MaxOutput: 128_000},
	{Key: "claude-opus-4-8", Name: "Claude Opus 4.8", MaxContext: 1_000_000, MaxOutput: 128_000},
	{Key: "claude-opus-4-7", Name: "Claude Opus 4.7", MaxContext: 1_000_000, MaxOutput: 128_000},
	{Key: "claude-sonnet-5", Name: "Claude Sonnet 5", MaxContext: 1_000_000, MaxOutput: 128_000},
	{Key: "claude-sonnet-4-6", Name: "Claude Sonnet 4.6", MaxContext: 1_000_000, MaxOutput: 128_000},
	{Key: "claude-haiku-4-5", Name: "Claude Haiku 4.5", MaxContext: 200_000, MaxOutput: 64_000},
	{Key: "claude-opus-4.5", Name: "Claude Opus 4.5", MaxContext: 200_000},
	{Key: "claude-sonnet-4.5", Name: "Claude Sonnet 4.5", MaxContext: 200_000},
	{Key: "claude-haiku-4.5", Name: "Claude Haiku 4.5", MaxContext: 200_000, MaxOutput: 64_000},
	{Key: "claude-sonnet-4", Name: "Claude Sonnet 4", MaxContext: 200_000},
	...
	// Google
	{Key: "gemini-3.6-flash", Name: "Gemini 3.6 Flash", MaxContext: 1_048_576, MaxOutput: 65_536},
	{Key: "gemini-3.5-flash-lite", Name: "Gemini 3.5 Flash Lite", MaxContext: 1_048_576, MaxOutput: 65_536},
	{Key: "gemini-3.5-flash", Name: "Gemini 3.5 Flash", MaxContext: 1_048_576, MaxOutput: 65_536},
	{Key: "gemini-3.1-flash-lite", Name: "Gemini 3.1 Flash Lite", MaxContext: 1_048_576, MaxOutput: 65_536},
	{Key: "gemini-3.1-pro", Name: "Gemini 3.1 Pro", MaxContext: 1_048_576, MaxOutput: 65_536},
	{Key: "gemini-3-flash", Name: "Gemini 3 Flash", MaxContext: 1_048_576, MaxOutput: 65_536},
	...
	// Sistemas de orquestación y modelos abiertos recientes
	{Key: "fugu-ultra", Name: "Sakana Fugu Ultra", MaxContext: 1_000_000},
	{Key: "inkling-small", Name: "Inkling Small", MaxContext: 1_000_000},
	{Key: "inkling", Name: "Inkling", MaxContext: 1_000_000},
	{Key: "muse-spark-1.1", Name: "Muse Spark 1.1", MaxContext: 1_048_576},

...
func init() {
	moduleapi.Register(moduleapi.Definition{
		...
		Commands: []moduleapi.Command{
			...
			{
				Name: "resume", Aliases: []string{"continue", "continuar"}, Order: 350,
				Description: "Reabre el Goal pausado, bloqueado, interrumpido o completado sin cambiar su objetivo.",

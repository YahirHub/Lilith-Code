...
- Pruebas aisladas de `internal/tools` en laboratorio temporal con imports locales: PASS para las herramientas de skills y materialización mediante `tool_search`.
